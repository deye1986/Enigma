...
def enigma():
    ...
    message = input('INPUT MESSAGE TO BE CODED (CTRL + C to quit) - Works best one word at a time \n >>> ')
    if message == '':
        enigma()
    else:
        ...
        lamp = [24, 17, 20, 7, 16, 18, 11, 3, 15, 23, 13, 6, 14, 10, 12, 8, 4, 1, 5, 25, 2, 22, 21, 9, 0, 19]
